...
## [CTest 命令](https://cmake.org/cmake/help/latest/manual/cmake-commands.7.html#id5)
...
## [不推荐使用的命令](https://cmake.org/cmake/help/latest/manual/cmake-commands.7.html#id6)

这些命令已弃用，仅用于保持向后兼容性。每个命令的文档都说明了不推荐使用的 CMake 版本。不要在新代码中使用这些命令。
